...
const Collections = () => {
  ...
  return (
    ...
    sm:max-[1099px]:max-h-[496px] 
    max-sm:flex-[1_0_80%] 
    max-sm:[scroll-snap-align:start]
    
    lg:[flex-basis:0] 
    lg:[aspect-ratio:480/600]
  "
      >
        <Image
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-2xl">
            ...
            <h1 className="uppercase text-4xl lg:text-5xl font-extrabold text-white mb-6">
              Iconic.
            </h1>
            <a
