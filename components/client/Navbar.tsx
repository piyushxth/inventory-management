...
const Navlinks = ["Shop", "About", "Special Events"];
...
const Navbar = () => {
  ...
  return (
    <nav
      ref={navbarRef}
      className={`group hover:bg-white border-b border-white ${
        isSticky
          ? "fixed top-0 left-0 right-0 z-50 bg-white shadow-lg"
          : "absolute top-0 left-0 right-0 z-50"
      } fs-200 flex items-center justify-betweens transition-all duration-300`}
    >
      <ul className="flex items-center w-full">
        <li className="flex">
          ...
          >
            <div className="block w-[136px] h-[15px] lg:w-[145px] lg:h-[16px]">
              <svg
